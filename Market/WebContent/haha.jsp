...
<body>
	<form method="post" action='UserInfoController' name="add user">
		...
		User Name: <input
			...
			value = "<c:out value = "${userInfo.getUserName()}" />" /><br />
		User Password: <input
			type = "text" name = "user_password"
			value = "<c:out value = "${userInfo.getUserPassword()}" />" /><br />
		User Mail: <input
			type = "text" name = "user_mail"
			value = "<c:out value = "${userInfo.getUserMail()}" />" /><br />
		User Add: <input
			type = "text" name = "user_add"
			value = "<c:out value = "${userInfo.getUserAdd()}" />" /><br />
		User Tel: <input
			type = "text" name = "user_tel"
			value = "<c:out value = "${userInfo.getUserTel()}" />" /><br />
