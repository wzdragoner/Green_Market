...
<body class="grey">
	...
	<div class="userPosition comWidth">
		<strong><a href="#">首页</a></strong> <span>&nbsp;&gt;&nbsp;</span> <a
			href="#">平板电脑</a> <span>&nbsp;&gt;&nbsp;</span> <a href="#">Apple
			苹果</a> <span>&nbsp;&gt;&nbsp;</span> <em>MD531CH/A</em>
	</div>
		...
		<div class="description clearfix">
			<div class="leftArea">
				<div class="description_imgs">
					...
					<ul class="des_smimg clearfix">
						<li><a href="#"><img src="../images/sm3.jpg"
			...
			<div class="rightArea">
				<div class="des_content ">
					<h3 class="des_content_tit">全网底价 Apple 苹果 iPad mini 16G wifi版
						平板电脑 前白后银 MD531CH/A 银白两色生 产批次不同混合发货</h3>
					<div class="dl clearfix">
						<div class="dt">慕课价</div>
						<div class="dd">
							<span class="des_money"><em>￥</em>999.00</span>
						</div>
					</div>
					<div class="dl clearfix">
						<div class="dt">优惠</div>
					...
					<div class="des_position">
						...
						<div class="dl clearfix">
							<div class="dt selectColor">选择颜色</div>
							<div class="dd clearfix">
								<div class="des_item des_item_active">WIFI 16G</div>
								<div class="des_item">WIFI 16G</div>
								<div class="des_item">WIFI 16G</div>
							</div>
						</div>
						<div class="dl clearfix">
							...
							<div class="dd clearfix">
								<div class="des_item des_item_active des_item_sm">WIFI 16G
								</div>
						...
						<div class="shop_buy">
							<a href="#" class="shopping_btn"></a> <span class="line"></span>
			...
			<div class="des_infoContent">
				...
				<div class="review_tab">
					...
					<div class="review_sort fr">
						<a href="#" class="review_time">时间排序</a> <a href="#"
							class="review_reco">推荐排序</a>
					</div>
				</div>
						...
						<div class="review_cont">
							<div class="review_t clearfix">
								<div class="startBox fl">
									<span class="start"></span><span class="start"></span><span
										class="start"></span><span class="start"></span>
								</div>
								<span class="starts_text fl">5分 满意</span>
							</div>
							<p>挺不错的，信赖慕课</p>
							<p>
								<a href="#" class="ding">顶(0)</a><a href="#" class="cai">踩(0)</a>
							</p>
						</div>
					</div>
					<div class="review_list clearfix">
