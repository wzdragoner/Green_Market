             ...
             <tbody>
                    <c:forEach items="${userInfos}" var="userInfo">
                           <tr>
                                 ...
                                 <td><a href="UserInfoController?action=edit&user_id=<c:out value="${userInfo.getUserId()}"/>">Update</a></td>
                    			 <td><a href="UserInfoController?action=delete&user_id=<c:out value="${userInfo.getUserId()}"/>">Delete</a></td>
                           </tr>
                    </c:forEach>
             </tbody>
       </table>
       <p><a href="UserInfoController?action=insert">Add User</a></p>
</body>
</html>