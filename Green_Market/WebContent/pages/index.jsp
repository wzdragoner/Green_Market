...
<body>
    ...
    <div class="banner_bar banner_big">
        <ul class="imgBox">
            <li><a href="#"><img src="../banner/banner_01.gif" alt="banner" id="bannerImg1"></a></li>
            <li><a href="#"><img src="../banner/banner_01.gif" alt="banner" id="bannerImg2"></a></li>
            <li><a href="#"><img src="../banner/banner_01.gif" alt="banner" id="bannerImg3"></a></li>
        </ul>
        <div class="con"></div>
    ...
    <div class="shopList comWidth clearfix">
        <div class="leftArea">
            <div class="banner_bar banner_sm">
                <ul class="imgBox">
                    <li><a href="#"><img src="../banner/banner_sm_01.png"></a></li>
                    <li><a href="#"><img src="../banner/food_banner_sm_01.png"></a></li>
                </ul>
                <div class="imgNum">
                    <a href="#" class="active"></a>
                    <a href="#"></a>
        ...
        <div class="rightArea">
            <div class="shopList_top ">
                <div class="shop_item">
                    <div class="shop_img">
                        <a href="#"><img src="../images/shopImg.png" alt="手机图片"></a>
                    </div>
                    <h3>HTC新渴望8系列</h3>
                    <p>1899元</p>
                </div>
            ...
            <div class="shopList_sm clearfix">
                <div class="shopItem_sm">
                    <div class="shopItem_smImg">
                        <a href="#"><img src="../images/shopImg.png"></a>
                    </div>
